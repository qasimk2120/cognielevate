...
export const organizationSchema = {
  ...
  image: OG_IMAGE_URL,
  description:
    "CogniElevate builds intelligent products and systems that reduce wasted time across productivity, shopping, healthcare, robotics and future markets.",
...
export const websiteSchema = {
  ...
  name: "CogniElevate",
  description:
    "CogniElevate builds intelligent products that remove friction, speed up decisions and reduce wasted time.",
  publisher: { "@id": ORG_ID },
  inLanguage: "en",
};
...
export const cognifocusSoftwareSchema = {
  ...
  publisher: { "@id": ORG_ID },
  description:
    "CogniFocus is an Android focus app that reacts to user behavior with focus sessions, Distraction Shield app blocking, recovery nudges, streaks, XP, and character-driven accountability.",
  offers: {
    "@type": "Offer",
    price: "0",
    priceCurrency: "USD",
...
export const webPageSchema = ({ id, url, name, description, breadcrumb }) => ({
  ...
  breadcrumb: breadcrumb
    ? { "@id": id.replace(/#webpage$/, "#breadcrumb") }
    : undefined,
});
